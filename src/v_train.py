...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if ros.temporal_bev_image_callback_flag  and ros.odom_callback_flag and ros.posearray_callback_flag and ros.laser_callback_flag and ros.is_start_callback_flag:
            ...
            ros.odom_dt = ros.current_odom_time - ros.previous_odom_time
            ...
            if ros.odom_dt != 0:
                velocity[0] = velocity[0] / ros.odom_dt
                velocity[1] = velocity[1] / ros.odom_dt
            ...
            if is_done:
                ...
                writer.writerow([episode, total_step, train_env.agent.brain.loss, train_env.reach_rate, total_reward, relative_goal[0], relative_goal[1]])
